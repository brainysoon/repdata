...
function dis() {
    ...
    var noAgree = document.getElementById('noAgree');
    var ui = document.getElementById("alertState");

    if (agree.checked || noAgree.checked) {
        mark1 = 1;
...
function uploadFile() {
    ...
    var agree = document.getElementById('agree');
    var noAgree = document.getElementById('noAgree');
    if (agree.checked) fd.append("bmark", $("#agree").val());
    if (noAgree.checked) fd.append("bmark", $("#noAgree").val());
